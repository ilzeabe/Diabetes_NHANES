...
# 2- scatter plot: age vs. a1c level
...
# 3- boxplot: bmi by ethnicity
(bmi_ethn <- ggplot(diabetes, 
                    aes(x = ethnicity,
                        y = BMI, 
                        fill = ethnicity)) +
...
# 4- barplot: income category by ethnicity 
...
# 6- stacked bar plot: income category vs. a1c category 
